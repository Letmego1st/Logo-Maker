...
describe('Circle', () => {
    test('display correctly', () => {
      ...
      expect(shape.display()).toEqual(`<circle cx="50%" cy="50%" r="100" height="100%" width="100%" fill="${color}">`);
    });
  });
  // Square Shape
  describe('Square', () => {
      test('display correctly', () => {
        ...
        var color =('green')
        shape.setColor(color);
        expect(shape.display()).toEqual(`<rect x="50" height="200" width="200" fill="${color}">`);
      });
    });
  // Triangle Shape
  describe('Triangle', () => {
      test('display correctly', () => {
        ...
        var color =('pink')
        shape.setColor(color);
        expect(shape.display()).toEqual(`<polygon height="100%" width="100%" points="0,200 300,200 150,0" fill="${color}">`);
      });
    });
